...
recipes = [
    ...
    dict(slug='golden-cauliflower-lemon-tahini', title='Golden Cauliflower with Lemon Tahini', cat='PLANT-FORWARD · OVEN', categories=['plant-forward'], img='golden-cauliflower-lemon-tahini.webp', alt='A top-down view of golden roasted cauliflower florets with toasted edges, drizzled with a beige tahini sauce and a light sprinkle of fresh parsley.', desc='Golden roasted cauliflower florets with toasted edges, finished with a creamy lemon tahini sauce.', serves='2', prep_time='35–40 min', total_time='35–40 min'), 
    dict(slug='golden-tofu-edamame-bowls', title='Golden Tofu & Edamame Bowls', cat='PROTEIN-FORWARD · SKILLET', categories=['protein-forward'], img='golden-tofu-edamame-bowls.webp', alt='A cream ceramic bowl filled with golden pan-fried tofu cubes, bright green edamame beans, and white rice, drizzled with a creamy peanut sauce.', desc='Golden pan-fried tofu, edamame and rice, brought together with a creamy peanut and lemon sauce.', serves='2', prep_time='25 min', total_time='25 min')
]
...
<section class="wrap recipe-index-body">
  ...
  <div class="empty-state" id="empty-state" hidden aria-live="polite">
    <div class="empty-state-inner">
      ...
      <p>This section will grow as the recipe collection expands. In the meantime, <a href="/recipes/">browse all {len(recipes)} recipes</a>.</p>
    </div>
  </div>
